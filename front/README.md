...
The admin dashboard lives on the `/onboard-client` page alongside the client
token onboarding form.

1. Open `http://localhost:5173/onboard-client` (or `http://localhost:8080/onboard-client` in Docker).
